...
export default function About() {
    return (
        <article className='aboutLittleLemon'>
            ...
            <aside className="aboutPicturesAside">
                <img className="aboutPicture1" src={adrianandmarioa} alt="Adrian and Mario"/>
                <img className="aboutPicture2" src={restaurant} alt="The restaurant"/>
            </aside>
        </article>
    );
}